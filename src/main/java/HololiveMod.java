...
public class HololiveMod implements  EditCharactersSubscriber,EditStringsSubscriber,EditCardsSubscriber,EditRelicsSubscriber,EditKeywordsSubscriber,OnCardUseSubscriber,OnPlayerDamagedSubscriber,OnStartBattleSubscriber,PostBattleSubscriber,PostInitializeSubscriber,PostDungeonInitializeSubscriber{
    ...
    public void receiveEditKeywords() {
		if (language == Settings.GameLanguage.ZHT) {
            BaseMod.addKeyword(new String[]{"Vtuber"},"Vtuber會在你回合結束時攻擊，並且受到傷害時Vtuber代替你受到傷害。");
            BaseMod.addKeyword(new String[]{"攻擊"},"你的回合結束前，所有Vtuber會發動攻擊。");
            BaseMod.addKeyword(new String[]{"追擊"}, "有追擊效果的Vtuber在攻擊時會附帶一些效果。");
            BaseMod.addKeyword(new String[]{"結尾"}, "有結尾效果的Vtuber在死亡時會附帶一些效果。");
            BaseMod.addKeyword(new String[]{"開始"}, "有開始效果的Vtuber從手牌召喚時會附帶一些效果。");
            BaseMod.addKeyword(new String[]{"受傷"}, "有受傷效果的Vtuber受到傷害時會附帶一些效果。");
            BaseMod.addKeyword(new String[]{"選擇"}, "從複數卡牌中選擇一張並執行其效果。預設為3張。");
            BaseMod.addKeyword(new String[]{"魔法"}, "選擇一種效果並執行，若詩音在場上時效果增強。不受aki角色影響。");
            BaseMod.addKeyword(new String[]{"程序"}, "抽到時消耗，若牌堆尚有牌則抽一張牌。");
            BaseMod.addKeyword(new String[]{"嘲諷"}, "具有嘲諷效果的Vtuber會優先成為被攻擊對象。");
            BaseMod.addKeyword(new String[]{"燃燒"}, "每當一位Vtuber死亡，每一層燃燒會給予對象1點傷害。");
            BaseMod.addKeyword(new String[]{"被追殺"}, "回合結束時受到等同於負面效果種類數量的5倍傷害。");
            BaseMod.addKeyword(new String[]{"組合"}, "當你卡組有特殊Vtuber組合時，可產生特殊效果。");
            BaseMod.addKeyword(new String[]{"卍組成員"}, "湊阿庫婭，百鬼綾目，紫咲詩音");
            BaseMod.addKeyword(new String[]{"索蘭節"}, "你每召喚一個Vtuber，每有一層使其+1/+1。");
            BaseMod.addKeyword(new String[]{"耐久直播"}, "你回合结束时，每有一層所有對有+1生命值。");
            BaseMod.addKeyword(new String[]{"組合：卍組"}, " #b湊阿庫婭 + #b紫咲詩音 + #b百鬼綾目 ");
            BaseMod.addKeyword(new String[]{"組合：夏色吹雪"}, " #b夏色祭 + #b白上吹雪 ");
            BaseMod.addKeyword(new String[]{"組合：PekoMiko"}, " #b兔田佩克拉 + #櫻巫女 ");
            BaseMod.addKeyword(new String[]{"組合：Gamers"}, " #b白上吹雪 + #b大神澪 + #b貓又小粥 + #b戌神沁音 ");
            BaseMod.addKeyword(new String[]{"組合：CN一期生"}, " #b夜霧 + #b希薇婭 + #b黑桃影 ");
            BaseMod.addKeyword(new String[]{"組合：金髮組"}, " #b赤井心 + #b亞奇羅森 + #b癒月巧可 + #b夜空梅露 + #b不知火芙蕾雅 + #b角卷綿芽 ");
            BaseMod.addKeyword(new String[]{"組合：FAMS"}, " #b白上吹雪 + #b大神澪 + #b大空昴 + #b百鬼綾目 ");
            BaseMod.addKeyword(new String[]{"組合：狼科組"}, " #b白上吹雪 + #b大神澪 ");
            BaseMod.addKeyword(new String[]{"組合：貓狗組"}, " #b貓又小粥 + #b戌神沁音 ");
            BaseMod.addKeyword(new String[]{"組合：海藍寶石"}, " #b湊阿库婭 + #b寶鐘瑪琳 ");
            BaseMod.addKeyword(new String[]{"組合：空A"}, " #b時乃空 + #b友人A ");
            BaseMod.addKeyword(new String[]{"組合：銀火"}, " #b白銀諾艾爾 + #b不知火芙蕾雅 ");
            BaseMod.addKeyword(new String[]{"組合：夏紫"}, " #b夏色祭 + #b紫咲詩音 ");
            BaseMod.addKeyword(new String[]{"組合：零期生"}, " #b时乃空 + #b友人A + #b萝卜子 + #b樱巫女 + #b星街彗星 ");
            BaseMod.addKeyword(new String[]{"組合：一期生"}, " #b夜空梅露 + #b赤井心 + #b亞奇羅森 + #b白上吹雪 + #b夏色祭 ");
            BaseMod.addKeyword(new String[]{"組合：二期生"}, " #b大空昴 + #b百鬼綾目 + #b湊阿库婭 + #b紫咲詩音 + #b癒月巧可 ");
            BaseMod.addKeyword(new String[]{"組合：三期生"}, " #b兔田佩克拉 + #b潤羽露西婭 + #b不知火芙蕾雅 + #b寶鐘瑪琳 + #b白銀諾艾爾 ");
            BaseMod.addKeyword(new String[]{"組合：四期生"}, " #b角卷綿芽 + #b常闇永遠 + #b桐生可可 + #b天音彼方 + #b姬森璐娜 ");
            BaseMod.addKeyword(new String[]{"組合：MUSIC"}, " #bAZKi + #b星街彗星 ");
            BaseMod.addKeyword(new String[]{"組合：全員"}, " #y讓我思考一下 ");
            BaseMod.addKeyword(new String[]{"組合：心羊"}, " #b赤井心 + #b角卷绵芽 ");
            BaseMod.addKeyword(new String[]{"組合：夏娜"}, " #b夏色祭 + #b姬森璐娜 ");
            BaseMod.addKeyword(new String[]{"組合：同居組"}, " #b天音彼方 + #b桐生可可 + #b星街彗星 ");
            BaseMod.addKeyword(new String[]{"組合：CN二期生"}, " #b阿媂婭 + #b朵莉絲 + #b羅莎琳 ");
            BaseMod.addKeyword(new String[]{"組合：Hololive-ID"}, " #bAyundaRisu + #bMoonaHoshinova + #bAiraniIofifteen ");
			
			//以下為預訂新增組合
			BaseMod.addKeyword(new String[]{"組合：露西婭！！！"}, " #b潤羽露西婭 + #b寶鐘瑪琳");
			BaseMod.addKeyword(new String[]{"組合：五期生"}, " #b雪花菈米 + #b桃鈴音音 + #b丸尾波爾卡 + #b獅白牡丹");
			BaseMod.addKeyword(new String[]{"組合：真．五期生"}, " #b雪花菈米 + #b桃鈴音音 + #b丸尾波爾卡 + #b獅白牡丹 + #b魔乃阿蘿耶");
			BaseMod.addKeyword(new String[]{"組合：EN一期生"}, " 名子懶得查，先空著");
			BaseMod.addKeyword(new String[]{"組合：Hey Moona!"}, " #b兔田佩克拉 + #bMoonaHoshinova ");
			BaseMod.addKeyword(new String[]{"組合：日清兼三大建設兼Impolster組"}, " #b湊阿庫婭 + #b大空昴 + #b兔田佩克拉 ");
			BaseMod.addKeyword(new String[]{"組合：惡魔組"}, " #b魔乃阿蘿耶 + #b常闇永遠 ");
			BaseMod.addKeyword(new String[]{"組合：T0組"}, " #b白銀諾艾爾 + #b癒月巧可 + #b這裡是阿梅 ");
			BaseMod.addKeyword(new String[]{"組合：絕 壁 六 人 眾"}, " #b友人A + #b星街彗星 + #b夏色祭 + #b紫咲詩音 + #b潤羽露西婭 + #b天音彼方 ");
